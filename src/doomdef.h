...
typedef enum
{
	...
	SKINCOLOR_MAROON,
        SKINCOLOR_ASH,
        SKINCOLOR_WATERMELON,
        SKINCOLOR_AFTERNOON,
	SKINCOLOR_FLAME,
	SKINCOLOR_SCARLET,
	SKINCOLOR_KETCHUP,
        SKINCOLOR_HOTDOG,
        SKINCOLOR_GRAPEFRUIT,
        SKINCOLOR_LEMONADE,
        SKINCOLOR_SAFFRON,
	SKINCOLOR_DAWN,
	SKINCOLOR_SUNSET,
	...
	SKINCOLOR_PURPLE,
        SKINCOLOR_PLUM,
        SKINCOLOR_NIGHTSHADE,
        SKINCOLOR_MAGENTA,
	SKINCOLOR_FUCHSIA,
	SKINCOLOR_TOXIC,
	SKINCOLOR_MAUVE,
	SKINCOLOR_LAVENDER,
        SKINCOLOR_BLACKBERRY,
	SKINCOLOR_BYZANTIUM,
        SKINCOLOR_WINE,
